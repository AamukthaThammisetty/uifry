  ...
  return (
    <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className=" justify-center gap-16 md:flex">
        ...
        <div className=" mt-10 space-y-6 gap-16 justify-between text-black sm:flex md:space-y-0 md:mt-0">
          {
              ...
              <ul className="space-y-4 " key={idx}>
                ...
                {item.label === "Newsletter" && (
                  <form onSubmit={(e) => e.preventDefault()} className="mt-4">
                    ...
                    <button className=" w-auto py-3 px-4 font-medium text-sm text-center text-white bg-black active:shadow-none rounded-lg shadow mt-2">
                      Subscribe
                    </button>
                    </div>
                  </form>
